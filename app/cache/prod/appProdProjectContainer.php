...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Blameable\BlameableSubscriber($a, true, 'Knp\\DoctrineBehaviors\\Model\\Blameable\\Blameable', new \Knp\DoctrineBehaviors\ORM\Blameable\UserCallable($this), 'FactelBundle\\Entity\\User'));
        ...
        $b->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Timestampable\TimestampableSubscriber($a, true, 'Knp\\DoctrineBehaviors\\Model\\Timestampable\\Timestampable'));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'renesan1_fact', 'user' => 'renesan1_fact', 'password' => 'renesan020491', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_62508cc8c1872.php');
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager62508cc8c1872_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($this->get('doctrine.orm.default_entity_manager.delegate'), $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_bb3c25496adc4176f3766b8a6ebbabb352b5e37268c054e322e89de6b65888f8');
        return $instance;
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'renesan1_fact',
            'database_user' => 'renesan1_fact',
            'database_password' => 'renesan020491',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_62508cc8c1872.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager62508cc8c1872_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
