 ...
 */
class CampoAdicional extends \FactelBundle\Entity\CampoAdicional implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'factura', 'proforma', 'liquidacionCompra', 'notaCredito', 'notaDebito', 'retencion', 'guia', 'nombre', 'valor'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CampoAdicional $proxy) {
