 ...
 */
class CargaError extends \FactelBundle\Entity\CargaError implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FactelBundle\\Entity\\CargaError' . "\0" . 'id', 'message', 'cargaArchivo', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CargaError $proxy) {
    ...
    public function setCargaArchivo(\FactelBundle\Entity\CargaArchivo $cargaArchivo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCargaArchivo', [$cargaArchivo]);

        return parent::setCargaArchivo($cargaArchivo);
    }
    ...
    public function getCargaArchivo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCargaArchivo', []);

        return parent::getCargaArchivo();
    }
