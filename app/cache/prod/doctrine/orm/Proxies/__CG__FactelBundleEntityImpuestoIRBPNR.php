 ...
 */
class ImpuestoIRBPNR extends \FactelBundle\Entity\ImpuestoIRBPNR implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'codigoPorcentaje', 'nombre', 'productos', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImpuestoIRBPNR $proxy) {
