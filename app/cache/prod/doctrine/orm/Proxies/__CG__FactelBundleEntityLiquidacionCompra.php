 ...
 */
class LiquidacionCompra extends \FactelBundle\Entity\LiquidacionCompra implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'claveAcceso', 'numeroAutorizacion', 'fechaAutorizacion', 'estado', 'ambiente', 'tipoEmision', 'secuencial', 'formaPago', 'plazo', 'fechaEmision', 'nombreArchivo', 'cliente', 'emisor', 'establecimiento', 'ptoEmision', 'composAdic', 'liquidacionesCompraHasProducto', 'mensajes', 'reembolsos', 'totalSinImpuestos', 'subtotal12', 'subtotal0', 'subtotalNoIVA', 'subtotalExentoIVA', 'valorICE', 'valorIRBPNR', 'iva12', 'totalDescuento', 'propina', 'valorTotal', '' . "\0" . 'FactelBundle\\Entity\\LiquidacionCompra' . "\0" . 'firmado', '' . "\0" . 'FactelBundle\\Entity\\LiquidacionCompra' . "\0" . 'enviarSiAutorizado', 'observacion', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LiquidacionCompra $proxy) {
