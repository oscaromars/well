 ...
 */
class LiquidacionCompraHasProducto extends \FactelBundle\Entity\LiquidacionCompraHasProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'producto', 'liquidacionCompra', 'impuestos', 'cantidad', 'nombre', 'codigoProducto', 'precioUnitario', 'descuento', 'valorTotal'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LiquidacionCompraHasProducto $proxy) {
    ...
    public function addImpuesto(\FactelBundle\Entity\Impuesto $impuesto)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addImpuesto', [$impuesto]);

        return parent::addImpuesto($impuesto);
    }
    ...
    public function removeImpuesto(\FactelBundle\Entity\Impuesto $impuesto)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeImpuesto', [$impuesto]);

        return parent::removeImpuesto($impuesto);
    }
    ...
    public function addDetallesAdicionale(\FactelBundle\Entity\DetalleAdicional $detallesAdicionale)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addDetallesAdicionale', [$detallesAdicionale]);

        return parent::addDetallesAdicionale($detallesAdicionale);
    }
    ...
    public function removeDetallesAdicionale(\FactelBundle\Entity\DetalleAdicional $detallesAdicionale)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeDetallesAdicionale', [$detallesAdicionale]);

        return parent::removeDetallesAdicionale($detallesAdicionale);
    }
