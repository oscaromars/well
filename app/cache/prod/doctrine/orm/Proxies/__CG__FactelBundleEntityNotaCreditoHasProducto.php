 ...
 */
class NotaCreditoHasProducto extends \FactelBundle\Entity\NotaCreditoHasProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'producto', 'notaCredito', 'impuestos', 'detallesAdicionales', 'cantidad', 'nombre', 'codigoProducto', 'precioUnitario', 'descuento', 'valorTotal'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NotaCreditoHasProducto $proxy) {
