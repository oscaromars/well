 ...
 */
class ProformaHasProducto extends \FactelBundle\Entity\ProformaHasProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'producto', 'proforma', 'impuestos', 'cantidad', 'nombre', 'codigoProducto', 'precioUnitario', 'descuento', 'valorTotal', 'precioSinSubsidio'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProformaHasProducto $proxy) {
