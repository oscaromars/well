 ...
 */
class Role extends \FactelBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', '' . "\0" . 'FactelBundle\\Entity\\Role' . "\0" . 'users', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy'];
        }
