...
/* FactelBundle:LiquidacionCompra:new.html.twig */
class __TwigTemplate_ec5a5a152355ad24c470a3b8470126c341f4e72fcfc668f4d835338db12287c8 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("FactelBundle::Layout.html.twig", "FactelBundle:LiquidacionCompra:new.html.twig", 2);
        $this->blocks = array(
    ...
    {
        // line 3
        $context["secuencial"] = $this->getAttribute($this->getAttribute(($context["pto"] ?? null), 0, array(), "array"), "secuencialLiquidacionCompra", array());
        // line 4
    ...
    public function block_panel_title($context, array $blocks = array())
    {
        // line 9
        echo "
    <i class=\"fa fa-bar-chart-o fa-fw\"></i>Nueva Liquidacion <strong>Nro: ";
        // line 10
...
";
        ...
        <div class=\"modal-dialog\">
            <div class=\"modal-content\">
                <div class=\"modal-header\">
                    ...
                    <h4 class=\"modal-title\" id=\"myModalLabel\">Seleccione el Proveedor</h4>
                </div>
    ...
    <form method=\"POST\" action=\"";
        // line 92
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("liquidacion_create");
        echo "\" id=\"formLiquidacion\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["flashMessage"]) {
            ...
            echo "                <div class=\"col-sm-12 alert alert-danger alert-dismissable\">
                    ...
                    <h4><strong>Ha ocurrido un error al crear la liquidacion!</strong></h4>
                    <p>";
            // line 98
        ...
        echo "</div>
                    ...
                    <div class=\"col-sm-6 col-lg-5\">
                        ...
                        <select class=\"form-control\" id=\"formaPago\" name=\"formaPago\" required=\"required\">
                            ...
                            <a href=\"../../../Entity/LiquidacionCompra.php\"></a>
        ...
        echo "\" />
            ...
            <div class=\"col-sm-6 \">
                <label>
                    <input type=\"checkbox\" value=false id=\"conReembolso\" name = \"conReembolso\" onchange=\"liquidacionCompraConReembolso(\$(this).is(':checked'))\">
                    <strong>Liquidacion Compra con Reembolso</strong>
                </label>
            </div>
...
";
    ...
    <script>
        ...
        echo "\",
                        ...
                        \$('#product-table tbody').on('click', 'tr', function (e) {
                            ...
                            if (null !== aData && \$(\"#idProducto\" + aData[0]).val() != aData[0])  // null if we clicked on title row
                            {
                                ...
                                var msg = \"<div class='col-sm-12 alert alert-warning alert-dismissable' id='alert-warning'>\" +
                                        \"<button type='button' class='close' data-dismiss='alert'>&times;</button>\" +
                                        \"<p>El producto <strong>\" + aData[3] + \"</strong> ya se encuentra en la liquidacion. Aumente la cantidad si lo necesita.</p></div>\";
                        ...
                        function liquidacionCompraConReembolso(value) {
                            if (value === true)
...
";
    ...
    {
        return "FactelBundle:LiquidacionCompra:new.html.twig";
    }
    ...
    {
        return array (  542 => 408,  471 => 340,  460 => 332,  456 => 331,  451 => 330,  448 => 329,  262 => 146,  257 => 145,  255 => 144,  222 => 118,  214 => 117,  204 => 110,  200 => 109,  196 => 108,  192 => 107,  184 => 106,  180 => 105,  176 => 104,  171 => 101,  162 => 98,  157 => 95,  153 => 94,  148 => 92,  82 => 28,  79 => 27,  69 => 21,  51 => 10,  48 => 9,  45 => 8,  41 => 2,  35 => 6,  31 => 5,  29 => 4,  27 => 3,  11 => 2,);
    }
    ...
    {
        return new Twig_Source("", "FactelBundle:LiquidacionCompra:new.html.twig", "/home/renesan1/public_html/1/src/FactelBundle/Resources/views/LiquidacionCompra/new.html.twig");
    }
}
