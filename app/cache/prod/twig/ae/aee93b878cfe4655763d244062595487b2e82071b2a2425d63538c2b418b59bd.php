...
/* FactelBundle:Guia:index.html.twig */
class __TwigTemplate_ad30fa6be4840408796c7196eaa9733581d43b1b950aa11841775160952ba2ef extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("FactelBundle::Layout.html.twig", "FactelBundle:Guia:index.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    {
        // line 9
        echo "<i class=\"fa fa-bar-chart-o fa-fw\"></i> Guias
<div class=\"pull-right\">
    <a href=\"";
        // line 11
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("guia_new");
        echo "\">
...
";
    ...
    <table class=\"table table-striped table-bordered table-hover\" id=\"guia-table\">
        <thead>
            <tr>
                <th>Id</th>
                <th>No.</th>
...
<script src=\"";
        ...
        echo "\"></script>
<script>
    var oTable = \$(\"#guia-table\").dataTable({
        columnDefs: [
            {
                targets: 1,
        ...
        sAjaxSource: \"";
        // line 57
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("all_guia");
        echo "\",
        bProcessing: true,
        bServerSide: true,
        bSort: false,
    ...
    \$('#guia-table_filter input').unbind();
    \$('#guia-table_filter input').bind('keyup', function(e) {
        if (e.keyCode == 13) {
    ...
    {
        return "FactelBundle:Guia:index.html.twig";
    }
    ...
    {
        return array (  123 => 57,  106 => 43,  102 => 42,  98 => 41,  95 => 40,  92 => 39,  70 => 20,  67 => 19,  55 => 11,  51 => 9,  48 => 8,  42 => 6,  37 => 4,  34 => 3,  31 => 2,  11 => 1,);
    }
    ...
    {
        return new Twig_Source("", "FactelBundle:Guia:index.html.twig", "/home/renesan1/public_html/1/src/FactelBundle/Resources/views/Guia/index.html.twig");
    }
}
