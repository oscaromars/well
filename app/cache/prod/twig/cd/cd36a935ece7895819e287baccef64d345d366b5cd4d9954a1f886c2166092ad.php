...
/* FactelBundle:LiquidacionCompra:index.html.twig */
class __TwigTemplate_38e09b994ffd712ab38e0b54e0671a6c219987504316fe47b7a6b25c41ac9196 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("FactelBundle::Layout.html.twig", "FactelBundle:LiquidacionCompra:index.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    {
        // line 9
        echo "<i class=\"fa fa-bar-chart-o fa-fw\"></i> Liquidaciones Compra
<div class=\"pull-right\">
    <a href=\"";
        // line 11
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("liquidacion_new");
        echo "\">
...
";
    ...
    <table class=\"table table-striped table-bordered table-hover\" id=\"liquidacion-table\">
        <thead>
            <tr>
                <th>Id</th>
                <th>No.</th>
...
<script src=\"";
        ...
        echo "\"></script>
<script>
    var oTable = \$(\"#liquidacion-table\").dataTable({
        columnDefs: [
            {
                targets: 1,
        ...
        sAjaxSource: \"";
        // line 58
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("all_liquidaciones");
        echo "\",
        bProcessing: true,
        bServerSide: true,
        bSort: false,
    ...
    \$('#liquidacion-table_filter input').unbind();
    \$('#liquidacion-table_filter input').bind('keyup', function(e) {
        if (e.keyCode == 13) {
    ...
    {
        return "FactelBundle:LiquidacionCompra:index.html.twig";
    }
    ...
    {
        return new Twig_Source("", "FactelBundle:LiquidacionCompra:index.html.twig", "/home/renesan1/public_html/1/src/FactelBundle/Resources/views/LiquidacionCompra/index.html.twig");
    }
}
