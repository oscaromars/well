...
/* FactelBundle:Retencion:index.html.twig */
class __TwigTemplate_0f224b33c26ddf78d765ea77921c8882e42da0441296a3a203fb2792b2dada54 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("FactelBundle::Layout.html.twig", "FactelBundle:Retencion:index.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    {
        // line 9
        echo "<i class=\"fa fa-bar-chart-o fa-fw\"></i> Comprobantes Retenci&oacute;n
<div class=\"pull-right\">
    <a href=\"";
        // line 11
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("retencion_new");
        echo "\">
...
<div class=\"dataTable_wrapper table-responsive col-lg-12\">  
    <table class=\"table table-striped table-bordered table-hover\" id=\"retencion-table\">
        <thead>
            <tr>
                <th>Id</th>
                <th>No.</th>
...
<script src=\"";
        ...
        echo "\"></script>
<script>
    var oTable = \$(\"#retencion-table\").dataTable({
        columnDefs: [
            {
                targets: 1,
        ...
        sAjaxSource: \"";
        // line 59
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("all_retenciones");
        echo "\",
        bProcessing: true,
        bServerSide: true,
        bSort: false,
    ...
    \$('#retencion-table_filter input').unbind();
    \$('#retencion-table_filter input').bind('keyup', function(e) {
        if (e.keyCode == 13) {
    ...
    {
        return "FactelBundle:Retencion:index.html.twig";
    }
    ...
    {
        return new Twig_Source("", "FactelBundle:Retencion:index.html.twig", "/home/renesan1/public_html/1/src/FactelBundle/Resources/views/Retencion/index.html.twig");
    }
}
